<div x-show="activeTab === 'contact'" class="space-y-6" style="display: none;">
        ...
        <div class="flex items-start gap-4">
            <div class="flex items-center h-10">
                <input type="checkbox"
                       ...
                       id="show_email"
                       value="1"
                       <?php echo e($settings->show_email ? 'checked' : ''); ?>
        ...
        <div class="flex items-start gap-4">
            <div class="flex items-center h-10">
                <input type="checkbox"
                       ...
                       id="show_phone"
                       value="1"
                       <?php echo e($settings->show_phone ? 'checked' : ''); ?>
        ...
        <div class="flex items-start gap-4">
            <div class="flex items-center h-10">
                <input type="checkbox"
                       ...
                       id="show_address"
                       value="1"
                       <?php echo e($settings->show_address ? 'checked' : ''); ?>
            ...
            <div class="flex-1">
                ...
                <textarea name="contact_address"
                          rows="2"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="Calle 123 #45-67, Bogotá, Colombia"><?php echo e(old('contact_address', $settings->contact_address)); ?></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="flex items-start gap-4">
            <div class="flex items-center h-10">
                <input type="checkbox"
                       ...
                       id="show_map"
                       value="1"
                       <?php echo e($settings->show_map ? 'checked' : ''); ?>
            ...
            <div class="flex-1">
                ...
                <textarea name="google_maps_url"
                          ...
                          placeholder="Pega aquí el código iframe completo o la URL de embed de Google Maps"><?php echo e(old('google_maps_url', $settings->google_maps_url)); ?></textarea>
    ...
    <div class="border rounded-lg p-4 bg-white shadow-sm">
        ...
        <input type="email"
               ...
               value="<?php echo e(old('notification_email', $settings->notification_email)); ?>"
    ...
    <div class="border rounded-lg p-4 bg-white shadow-sm">
        ...
        <textarea name="business_hours"
                  rows="3"
                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Ejemplo:&#10;Lunes a Viernes: 9:00 AM - 6:00 PM&#10;Sábados: 10:00 AM - 2:00 PM&#10;Domingos: Cerrado"><?php echo e(old('business_hours', $settings->business_hours)); ?></textarea>
        <p class="text-xs text-gray-500 mt-2">
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/admin/settings/partials/contact.blade.php ENDPATH**/ ?>