...
<div <?php echo e($attributes->merge(['class' => 'bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition'])); ?>>
    <?php if($title): ?>
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/components/admin/card.blade.php ENDPATH**/ ?>