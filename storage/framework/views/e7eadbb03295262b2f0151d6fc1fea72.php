<?php if(($settings->shop_enabled ?? true) && isset($products) && $products->count()): ?>
        ...
        <div class="max-w-6xl mx-auto">
            <div class="<?php echo e($gridClasses); ?>">
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="w-full max-w-sm product-card" style="animation-delay: <?php echo e($loop->index * 0.1); ?>s">
...
<?php endif; ?>
<?php /**PATH D:\htdocs\skubox\landing\resources\views/landing/sections/shop.blade.php ENDPATH**/ ?>