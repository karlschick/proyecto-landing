<section class="py-20 bg-gradient-to-r from-black via-gray-900 to-black relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in" style="animation-delay: 0.4s;">
            ...
            <?php if($settings->hasWhatsApp()): ?>
            <a href="<?php echo e($settings->getWhatsAppLink()); ?>"
               target="_blank"
               rel="noopener noreferrer"
               class="inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-bold text-lg transition shadow-2xl transform hover:scale-105">
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/landing/sections/cta.blade.php ENDPATH**/ ?>