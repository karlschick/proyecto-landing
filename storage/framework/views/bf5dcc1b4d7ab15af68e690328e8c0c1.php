...
<head>
    ...
    <?php if($settings->favicon): ?>
        <link rel="icon" type="image/x-icon" href="<?php echo e($settings->getFaviconUrl()); ?>?v=<?php echo e(time()); ?>">
    <?php else: ?>
...
<body class="bg-gray-100" x-data="{ sidebarOpen: false }">
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 transform transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0"
            ...
            <div class="flex items-center justify-center h-16 bg-gray-800 border-b border-gray-700">
                <?php if($settings->logo): ?>
                    <img src="<?php echo e($settings->getLogoUrl()); ?>" alt="<?php echo e($settings->site_name); ?>" class="h-10 w-auto">
                <?php else: ?>
            ...
            <nav class="mt-8 px-4 pb-20 overflow-y-auto h-[calc(100vh-8rem)]">
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                   class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-gray-800 text-white' : ''); ?>">
        ...
        <div class="mt-6">
            ...
            class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-gray-800 text-white' : ''); ?>">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-6">
                    ...
                    class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.hero.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.about.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.projects.index')); ?>"
                       class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.projects.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        Proyectos
                    ...
                    <a href="<?php echo e(route('admin.testimonials.index')); ?>"
                       class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.testimonials.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.gallery.index')); ?>"
                       class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.gallery.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                        </svg>
                        Galería
                    ...
                    <a href="<?php echo e(route('admin.leads.index')); ?>"
                        class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.leads.*') ? 'bg-gray-800 text-white' : ''); ?>">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.products.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    class="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-lg transition mb-1 <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-gray-800 text-white' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-gray-900 shadow-sm z-10">
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="text-gray-200 hover:text-gray-400 flex items-center">
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/admin/layout.blade.php ENDPATH**/ ?>