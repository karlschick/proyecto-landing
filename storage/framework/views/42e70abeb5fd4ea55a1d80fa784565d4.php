    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
      ...
      <div>
        <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-6">
          <?php echo e($settings->about_title ?? 'Functional Intelligent Training – FIT5'); ?>
...
<?php /**PATH D:\htdocs\Fitness\resources\views/landing/sections/about.blade.php ENDPATH**/ ?>