    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
      ...
      <div>
        <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-6">
          <?php echo e($settings->about_title ?? 'Soluciones tecnológicas para tu negocio'); ?>

        </h2>

        <?php if($settings->about_description): ?>
          <div class="text-gray-900 mb-6 leading-relaxed space-y-4">
            <?php echo nl2br(e($settings->about_description)); ?>
      ...
      <div class="flex justify-center">
        <div class="image-neon-frame relative">
          <?php if($settings->about_image): ?>
            <img src="<?php echo e($settings->getAboutImageUrl()); ?>"
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/landing/sections/about.blade.php ENDPATH**/ ?>