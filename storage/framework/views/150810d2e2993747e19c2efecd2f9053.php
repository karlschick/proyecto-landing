            ...
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="relative bg-black rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 animate-from-top w-full sm:w-[calc(50%-0.75rem)] lg:w-[calc(25%-1.125rem)] max-w-xs group-card">
                    ...
                    <div class="relative z-10">
                        <div class="relative h-56 bg-white overflow-hidden group cursor-pointer" onclick="openImageModal('<?php echo e($project->getImageUrl()); ?>', '<?php echo e($project->title); ?>')">
                            <img src="<?php echo e($project->getImageUrl()); ?>"
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/landing/sections/projects.blade.php ENDPATH**/ ?>