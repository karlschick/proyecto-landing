<section id="galeria" class="py-16 bg-gradient-to-b from-[rgb(245,245,0)] to-black">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if($galleryImages->count() > 0): ?>
            ...
            <?php if($galleryCategories->count() > 1): ?>
            <div class="flex flex-wrap justify-center gap-3 mb-10" x-data="{ activeGalleryCategory: 'all' }">
                ...
                <button @click="activeGalleryCategory = '<?php echo e($category); ?>'; filterGallery('<?php echo e($category); ?>')"
                        :class="activeGalleryCategory === '<?php echo e($category); ?>' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'"
                        class="px-6 py-2 rounded-full font-medium transition">
                    <?php echo e($category); ?>
            ...
            <div class="relative">
                <div class="swiper gallerySwiper">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" data-category="<?php echo e($item->category ?? 'sin-categoria'); ?>">
                            <div class="relative aspect-square overflow-hidden rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer group"
                                 onclick="openLightbox('<?php echo e($item->getImageUrl()); ?>', '<?php echo e(addslashes($item->title ?? '')); ?>', '<?php echo e(addslashes($item->description ?? '')); ?>', '<?php echo e($item->type); ?>')">

                                <?php if($item->isVideo()): ?>
                                    
                                    <video class="w-full h-full object-cover" muted>
                                        <source src="<?php echo e($item->getImageUrl()); ?>" type="video/mp4">
                                    </video>
                                ...
                                <?php else: ?>
                                    ...
                                    <img src="<?php echo e($item->getImageUrl()); ?>"
                                         alt="<?php echo e($item->title ?? 'Imagen de galería'); ?>"
                                ...
                                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                                    <?php if($item->title): ?>
                                    <h3 class="text-white font-bold text-lg mb-1"><?php echo e($item->title); ?></h3>
                                    <?php endif; ?>
                                    <?php if($item->description): ?>
                                    <p class="text-white/90 text-sm"><?php echo e(Str::limit($item->description, 80)); ?></p>
                                    <?php endif; ?>
                                </div>
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/landing/sections/gallery.blade.php ENDPATH**/ ?>