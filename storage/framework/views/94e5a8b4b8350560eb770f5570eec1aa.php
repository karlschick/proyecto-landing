<div x-show="activeTab === 'seo'" class="space-y-6" style="display: none;">
    ...
    <div class="border rounded-lg p-4 bg-white shadow-sm">
        ...
        <textarea name="meta_description"
                  ...
                  x-data="{ count: <?php echo e(strlen($settings->meta_description ?? '')); ?> }"
                  x-on:input="count = $event.target.value.length"><?php echo e(old('meta_description', $settings->meta_description)); ?></textarea>
        ...
        <div class="mt-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="space-y-1">
                <h3 class="text-lg text-blue-600 hover:underline cursor-pointer font-medium">
                    <?php echo e($settings->site_name ?? 'Tu Sitio Web'); ?> - Inicio
                </h3>
                <p class="text-xs text-green-700"><?php echo e(url('/')); ?></p>
                <p class="text-sm text-gray-700">
                    <?php echo e($settings->meta_description ?? 'Tu descripción SEO aparecerá aquí...'); ?>
    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="border rounded-lg p-4 bg-white shadow-sm">
            ...
            <?php if($settings->google_analytics_id): ?>
...
<?php /**PATH D:\htdocs\skubox\landing\resources\views/admin/settings/partials/seo.blade.php ENDPATH**/ ?>