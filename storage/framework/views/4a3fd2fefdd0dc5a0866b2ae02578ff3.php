<div x-show="activeTab === 'footer'" class="space-y-6" style="display: none;">
    ...
    <div class="border rounded-lg p-4">
        <div class="flex items-start gap-3">
            <input type="checkbox" name="show_social_footer" id="show_social_footer" value="1"
                   <?php echo e($settings->show_social_footer ? 'checked' : ''); ?>
    ...
    <div>
        ...
        <textarea name="footer_text" rows="3"
                  ...
                  placeholder="© 2026 SKUBOX.IT     -     Todos los derechos reservados."><?php echo e(old('footer_text', $settings->footer_text)); ?></textarea>
    ...
    <div class="bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg p-6">
        <p class="text-xs text-gray-500 mb-3 uppercase font-semibold">Vista Previa:</p>
        <div class="bg-gray-900 text-white p-6 rounded-lg">
            <?php if($settings->show_social_footer): ?>
                ...
                <?php else: ?>
                <p class="text-center text-gray-500 text-sm italic mb-4">
            ...
            <p class="text-center text-sm text-gray-400">
                <?php echo e($settings->footer_text ?: '© ' . date('Y') . ' ' . ($settings->site_name ?: config('app.name')) . '. Todos los derechos reservados.'); ?>

            </p>
        </div>
    </div>
</div>
<?php /**PATH D:\htdocs\skubox\landing\resources\views/admin/settings/partials/footer.blade.php ENDPATH**/ ?>